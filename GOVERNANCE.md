...
This document describes how @sebastienrousseau/remark-config is run: who decides what, how
...
@sebastienrousseau/remark-config is **maintainer-led**. As of the current release line it has a single
