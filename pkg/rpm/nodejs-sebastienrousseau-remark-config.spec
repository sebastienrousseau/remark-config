...
%global npm_bare      remark-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-remark-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable Remark lint configuration files and rules adhering to 2026 standards

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/remark-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/remark-config is a shareable configuration preset with no runtime
