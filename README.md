...
<p align="center">
  Shareable Remark lint configuration files and rules adhering to 2026 standards
</p>
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/remark-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fremark-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/remark-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14517"><img src="https://img.shields.io/cii/level/14517?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [AST Markdown Linting & GFM](#ast-markdown-linting--gfm) — before and after rule comparison
...
Install `@sebastienrousseau/remark-config` as a development dependency:
...
`@sebastienrousseau/remark-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/remark-config` solves this with three deliberate engineering choices:
...
When parsing proprietary markdown variants (such as Hugo shortcodes or non-standard LaTeX math extensions) unsupported by Remark plugins.
